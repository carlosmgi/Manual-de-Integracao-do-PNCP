...
Contratações Anual (PCA) de uma unidade em determinado ano, opcionalmente
filtrando via Categoria do Item.
...
.. code-block:: bash
   ...
   curl -X GET \
     "https://treina.pncp.gov.br/api/pncp/v1/orgaos/00394460000141/pca/2022/1/itens" \
     -H "accept: */*"
...
.. list-table::
   ...
   * - 1.9
     - nomeCatalogo
     - Texto
     - Nome do Catálogo de itens utilizado
   ...
   * - 1.18
     - valorUnitario
     - Decimal
     - Valor unitário do item (maior ou igual a
   ...
   * - 1.25
     - dataPublicacaoPncp
     - Data
     - Data da publicação do item do plano no
       PNCP
   * - 1.26
     - dataInclusao
     - Data
   ...
   * - 1.28
     ...
     - Código do catálogo de materiais e/ ou
       serviços utilizado. Domínio: 1 - CNBS
       (Catálogo Nacional de Bens e Serviços);
       2 - Outros;
   * - 1.29
     - categoriaItemPcaNome
     - Inteiro
     - Nome da categoria do item conforme
       tabela de domínio Categoria do Item do
