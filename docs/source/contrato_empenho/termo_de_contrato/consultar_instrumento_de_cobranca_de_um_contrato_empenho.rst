...
.. code-block:: bash
  :linenos:
    ...
    curl -k -X GET "${BA-SE_URL}/v1/orgaos/10000000000003/contratos/2025/1/instrumentocobranca/1" 
    -H "Ac-cept: */*”
...
.. list-table::
   ...
   * - 4
     ...
     - Inteiro
     - Sim
     - Sequencial do instrumento de cobrança no PNCP; número sequencial gerado no momento da inclusão
...
.. list-table::
   ...
   * - 13
     - statusResponseNFe
     - Texto
     - Código de retorno HTTP retornado na consulta da nota fiscal eletrônica
   * - 14
     - jsonResponseNFe
     - Texto
     - JSON response retornado na consulta da nota fiscal eletrônica
   * - 15
   ...
   * - 15.10
     ...
     - Texto
     - Código do órgão superior destinatário
   * - 15.11
     - nomeOrgaoSuperiorDestinatario
     - Texto
     - Nome do órgão superior destinatário
   * - 15.12
     - valorNotaFiscal
     - Texto
   ...
   * - 15.15
     - dataInclusao
     - Data/Hora
     - Data/hora da gravação no PNCP
   * - 15.16
     - dataAtualizacao
     - Data/Hora
     - Data/hora da atualização no PNCP
   * - 15.17
     - itens
     - 
