Consultar Quantidade de Documentos de IRP
=========================================

Serviço que permite recuperar a quantidade de arquivos/documentos pertencentes a uma Intenção de Registro de Preço (IRP).
...
.. list-table::
   ...
   * - Endpoint
     - Método HTTP
   * - /v1/orgaos/{cnpj}/irp/{ano}/{sequencial}/arquivos/quantidade
     - GET
...
.. code-block:: bash
  ...
  :emphasize-lines: 1-3
	...
	curl -k -X GET \
	  "${BASE_URL}/v1/orgaos/10000000000003/irp/2021/1/arquivos/quantidade" \
	  -H "accept: */*"
...
.. list-table::
   ...
   * - :destaque-verde-claro:`1`
     ...
     - :destaque-verde-claro:`Inteiro`
     - :destaque-verde-claro:`Quantidade de arquivos/documentos pertencentes a uma Intenção de Registro de Preço`
