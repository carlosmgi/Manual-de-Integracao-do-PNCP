Consultar Quantidade de Itens da Intenção de Registro de Preço
==============================================================

Serviço que permite recuperar a quantidade de itens pertencentes a uma Intenção de Registro de Preço (IRP).
...
.. list-table::
   ...
   * - Endpoint
     - Método HTTP
   * - /v1/orgaos/{cnpj}/irp/{ano}/{sequencial}/itens/quantidade
     - GET
...
.. code-block:: bash
  ...
  :emphasize-lines: 1-3
	...
	curl -k -X GET \
	  "${BASE_URL}/v1/orgaos/10000000000003/irp/2021/1/itens/quantidade" \
	  -H "accept: */*"
...
.. list-table::
   ...
   * - :destaque-verde-claro:`1`
     ...
     - :destaque-verde-claro:`Inteiro`
     - :destaque-verde-claro:`Quantidade de itens pertencentes a uma Intenção de Registro de Preço`
