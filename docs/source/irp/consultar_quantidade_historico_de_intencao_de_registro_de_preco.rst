Consultar Quantidade Histórico de Intenção de Registro de Preço
===============================================================

Serviço que permite recuperar a quantidade de histórico pertencente a uma Intenção de Registro de Preço (IRP).
...
.. list-table::
   ...
   * - Endpoint
     - Método HTTP
   * - /v1/orgaos/{cnpj}/irp/{ano}/{sequencial}/historico/quantidade
     - GET
...
.. code-block:: bash
  ...
  :emphasize-lines: 1-3
	...
	curl -k -X GET \
	  "${BASE_URL}/v1/orgaos/10000000000003/irp/2021/1/historico/quantidade" \
	  -H "accept: */*"
