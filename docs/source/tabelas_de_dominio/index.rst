...
Benefícios das Tabelas de Domínio e Regras de Conformidade no PNCP:
...
.. toctree::
  ...
  tipo_de_contrato
  consultar_tipo_de_contrato_por_codigo
  consultar_tipos_de_contrato
  tipo_de_termo_de_contrato
  categoria_do_processo
  tipo_de_documento
  consultar_tipo_documento_por_codigo
  consultar_tipos_de_documento
  natureza_juridica
  amparo_legal
